    ...
    def main(self):
        ...
        while i < len(content):
            ...
            # 如果數字開頭
                ...
                temp = ''
                while i < len(content):
                    if content[i].isdigit() or ((content[i] == 'e' or content[i] == 'd') and content[i + 1].isdigit()):
                        temp += content[i]
                        i += 1
...
class Parser():
    def __init__(self):
        ...
        self.index = [0 for i in range(110)]
    ...
    def get_firstset(self):
        ...
        print "---------First---------"
        for i in range(1,len(self.vn) + 1):
            print self.nfa[i].name.ljust(30),
            for j in range(110):
                if self.nfa[i].first[j] == 1:
                    print self.index[j],
                    #print j,
            print ""
            #self.nfa[i].first
